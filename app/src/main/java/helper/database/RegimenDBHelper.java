 ...
 */
public class RegimenDBHelper extends SQLiteOpenHelper {
    ...
    public RegimenDBHelper(Context context) {
    ...
    public BGL getBGLByTime(String bglTime) {
        ...
        Cursor cursor = db.query(DATABASE_TABLE, new String[]{KEY_ID, KEY_TIME_STAMP, KEY_DATE_STAMP, KEY_BG_READING, KEY_COMMENT},
