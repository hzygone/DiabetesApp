        ...
        add.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    EditText date = (EditText) findViewById(R.id.NutritionDate);
                    EditText time = (EditText) findViewById(R.id.NutritionTime);
                    EditText duration = (EditText) findViewById(R.id.NutritionNotes);
                    if (date != null && time != null & duration != null) {
                        ...
                        //Duration parsing
                        String sNotes = duration.getText().toString().trim();

                        Nutrition nut = new Nutrition(inputDate, inputTime, sNotes);
